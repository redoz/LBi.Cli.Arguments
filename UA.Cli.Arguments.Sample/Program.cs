...
namespace UA.Cli.Arguments.Sample
{
    ...
    // Examples
    // UA.Cli.Arguments.Sample.exe -Name test -WhatIf -Parameters @{"foo" = "bar"}
    // UA.Cli.Arguments.Sample.exe -Path "c:\test\foo.txt" -WhatIf -Parameters @{"foo" = "bar"}
    // UA.Cli.Arguments.Sample.exe -Help -Detailed
    class Program
    {
